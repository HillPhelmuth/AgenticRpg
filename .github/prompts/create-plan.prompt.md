...
**Project Description:** An AI-driven, agent-based RPG game platform where players can create characters, join campaigns, and engage in dynamic storytelling and combat scenarios orchestrated by intelligent agents.

**Technical Requirements:** Microsoft Agent Framework, SignalR hub Groups, robust state management, data persistence, user-friendly AI-first interface.
...
This prompt uses the structure from: `PLANNING.template.md`
